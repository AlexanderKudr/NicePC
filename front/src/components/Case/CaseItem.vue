            ...
            <div class="left-box">
                ...
                <div>
                    ...
                    <ul class="cpu_specifications">
                        <li>Ядро: {{ case_item.param1 }}</li>
                        <li>Частота: {{ case_item.param2 }}</li>
                        <li>Число ядер: {{ case_item.param3 }}</li>
                        <li>Сокет: {{ case_item.param4 }}</li>
                        <li>Тепловыделение: {{ case_item.param5 }}</li>
                        <li>Технологический процесс: {{ case_item.param6 }}</li>
                    </ul>
                </div>
            </div>
            <div>
                <p class="cpu_price">{{ case_item.price }}₽</p>
